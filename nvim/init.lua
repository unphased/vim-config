...
vim.keymap.set("n", "<C-PageDown>", function () CycleWindowsOrBuffers(true, true) end, { desc = 'cycle windows or buffers' })
vim.keymap.set("n", "<s-tab>", function () CycleWindowsOrBuffers(false) end, { desc = 'cycle windows or buffers (back)' })
vim.keymap.set("n", "<C-PageUp>", function () CycleWindowsOrBuffers(false, true) end, { desc = 'cycle windows or buffers (back)' })
...
vim.keymap.set('n', '<leader>e', require('ts-node-action').node_action, {
  desc = "Treesitter Node Action (toggle)"
})
