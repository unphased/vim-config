...
vim.cmd([[
  ...
  hi Search cterm=bold gui=bold ctermfg=black ctermbg=yellow guibg=#f0c674 guifg=NONE
  hi incSearch cterm=bold gui=bold ctermfg=black ctermbg=yellow guibg=#f08634 guifg=NONE
]])
