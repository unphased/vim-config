...
test:
	...
	bash -n git-lg-full.sh test-herdr-copy-pane-id-plugin.sh test-herdr-focus.sh test-herdr-move-pane-new-tab-plugin.sh test-herdr-plugin-install.sh test-herdr-session-context.sh herdr-plugins/install.sh
	./test-linux-vt.sh
